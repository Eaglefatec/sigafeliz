...
I – Promover a integração entre os alunos dos cursos de tecnologia e áreas correlatas; <br>
II – Desenvolver projetos práticos do curso de Banco de Dados; <br>
...
III – Garantir que o Product Backlog esteja claro para todos; <br>
IV – Participar ativamente no processo de criação de ideias para o produto; <br>
V – Gerir a lista de pendências; <br>
VI – Priorizar as necessidades; <br>
VII – Aceitar ou rejeitar funcionalidades concluídas das Sprints; <br>
VIII – Manter comunicação com o cliente; <br>
...
III – Proteger o time de interferências externas; <br>
IV – Aumentar a autonomia do time; <br>
V – Dividir responsabilidades com o time; <br>
VI – Monitorar as tarefas da Sprint; <br>
...
III – Quebrar os itens em tarefas; <br>
IV – Gerenciamento do trabalho diário; <br>
V – Criação do Sprint Backlog; <br>
